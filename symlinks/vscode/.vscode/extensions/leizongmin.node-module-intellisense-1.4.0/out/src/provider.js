...
class IntellisenseProvider {
    constructor() {
        ...
        this.fileModuleExtensions = IntellisenseProvider.defaultfileModuleExtensions;
        this.disposables = [];
    }
    activate(context) {
    ...
    readCurrentDirectory(dir, prefix, isIncludeExtname) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            list.push(createCompletionItem("..", vscode_1.CompletionItemKind.File, {
                detail: "directory",
            ...
            for (const name of names) {
                ...
                if (stats.isDirectory()) {
                    // directory
                    list.push(createCompletionItem(`${prefix}${name}`, vscode_1.CompletionItemKind.File, {
                        detail: "directory",
...
IntellisenseProvider.defaultfileModuleExtensions = [".js", ".jsx", ".ts", ".d.ts", ".tsx", ".vue", ".json"];
 ...
 */
function parseFileExtensionName(filename, supportExtensions) {

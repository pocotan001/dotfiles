...
function definitionLocation_godef(document, isMod, offset, includeDocs, env, token) {
...
function definitionLocation_gogetdoc(document, isMod, includeDocs, position, offset, env, useTags, token) {
